  ...
  template: `
    ...
    <section class="info-section">
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card">
          <h3>30%</h3>
          <p>Of household members typically require treatment when one is affected</p>
        </div>
      </div>
      ...
      <div class="info-content">
        <div class="info-text">
          ...
          <p>Head lice have become increasingly resistant to over-the-counter treatments, making professional intervention more important than ever. Our specialized approach ensures complete elimination of both lice and nits (eggs), preventing recurring infestations.</p>
